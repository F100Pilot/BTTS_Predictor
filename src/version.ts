 ...
 */
export const APP_VERSION = '0.2.25.0';

/** Highlights of the current version, shown in the "what's new" popup on entry. */
export const WHATS_NEW: string[] = [
  'v0.2.25: Importar do FootyStats na Calculadora — cola o código-fonte da página de uma equipa e preenche automaticamente os golos, BTTS% e jogos (em casa/fora), sem CORS nem chamadas à API.',
