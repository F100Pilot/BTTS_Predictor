 ...
 */
export const APP_VERSION = '0.2.15.0';

/** Highlights of the current version, shown in the "what's new" popup on entry. */
export const WHATS_NEW: string[] = [
  'O painel passa a mostrar o lado dominante com etiqueta clara, ex.: "NÃO 68%" em vez de só "32%" — deixas de ficar na dúvida se é SIM ou NÃO.',
  'No Histórico podes agora apagar jogos individualmente (ícone do caixote) e vês o resultado (score) do jogo quando é conhecido.',
];
