...
/**
 * BTTS model-tuning controls: factor weights (+ optimize/reset), market-odds
 * calibration and the auto-calibration toggle. Rendered inside a pop-up in the
 * History tab (BTTS market) — these levers only exist for BTTS (the other
 * markets use a Poisson model with no factor weights).
 */
      ...
      <label className="flex items-start gap-2 border-t pt-4 text-sm">
        ...
        <span>
          ...
          <span className="block text-xs font-normal text-muted-foreground">
            A app aprende com os resultados que registar no Histórico: corrige o excesso/defeito de
            confiança das previsões (recalibração estatística, ~15+ jogos) e otimiza automaticamente
            os pesos do modelo (~20+ jogos) — nos sliders acima, a barra vermelha mostra o valor
            anterior a cada otimização.
          </span>
        </span>
      </label>
    </div>
