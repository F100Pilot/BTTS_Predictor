...
/**
 * Generic connection test for any provider: tries to fetch today's fixtures
 * (and one team's recent matches) through the real provider implementation.
 * Used for providers other than Football-Data.org, which has a dedicated check.
 */
